...
# attention the libraries convert_from_path and tesseract don't work for the first time becouse you need to install the following packages
    # about convert_from_path you need to install poppler you can click the link to know how to install it "https://www.youtube.com/watch?v=SioLV0f0sr0&t=11s&ab_channel=CodingDiksha"
    # about tesseract you need to install tesseract you can click the link to know how to install it "https://www.youtube.com/watch?v=LMM6s9JL5GA&ab_channel=datascienceAnywhere"
...
# # this is a small test to know if this file works good make sure to uncomment  this 4 lines to test it
# PATH_FILE = "C:/Users/hamza/Desktop/Researches/Transformers.pdf"
